...
namespace EmployeeManagement.Models
{
    public class EmployeeRepository
    {
        ...
        static EmployeeRepository()
        {
            ...
            {
                new Models.Employee { EmployeeId = 1, FirstName = "Jenny", LastName = "Jones", Phone = "888-888-8888", DepartmentId = 1 },
                new Models.Employee { EmployeeId = 2, FirstName = "Bob", LastName = "Ross", Phone = "555-555-5555", DepartmentId = 2 },
                new Models.Employee { EmployeeId = 3, FirstName = "Jane", LastName = "Smith", Phone = "111-111-1111", DepartmentId = 3 }
            };
        }
